...
export const SnippetInspectorScreen: React.FC<SnippetInspectorScreenProps> = ({
  ...
  return (
    <div className="flex flex-col w-full pb-10 space-y-4 max-w-lg mx-auto">
      ...
      <div className="bg-[#171c23] rounded-xl p-3 border border-[#30353d]/40 shadow-md relative overflow-hidden">
        ...
        <div className="flex flex-col gap-2 relative z-10">
          <div className="flex items-start justify-between gap-2">
            <div className="flex flex-col">
              <h1 className="font-headline-lg-mobile font-semibold tracking-tight text-[#dee2ec]">
                {snippet.title}
              </h1>
              <div className="flex items-center gap-1 mt-1 text-[#bbcabf] font-code-sm">
            ...
            <div className="flex flex-wrap gap-1 items-center justify-end">
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#30353d] text-[#4cd7f6] font-label-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-[#4cd7f6]"></span>
                {effectiveLang === 'java' ? 'Java (OpenJDK 17)' : effectiveLang === 'cpp' ? 'C++ (GCC 12)' : effectiveLang === 'py' ? 'Python (3.11)' : effectiveLang === 'js' ? 'JavaScript (Node)' : effectiveLang.toUpperCase()}
              </span>
              <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-[#252a32] text-[#bbcabf] font-label-sm">
                {snippet.topic}
              </span>
            </div>
          </div>
          <p className="font-body-sm text-[#bbcabf] leading-relaxed bg-[#1b2027]/60 p-2.5 rounded-lg border border-[#30353d]/30">
            {snippet.description}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
        ...
        <button
          onClick={handleRun}
          disabled={isRunning}
          className="flex items-center justify-center gap-1.5 px-3 py-2.5 bg-[#4edea3] rounded-lg text-[#003824] font-code-md font-semibold active:scale-95 transition-all shadow-[0_0_16px_rgba(16,185,129,0.25)] hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] cursor-pointer"
        >
          <span
      ...
      <div className="flex flex-col bg-[#090f15] rounded-xl border border-[#30353d]/50 shadow-md overflow-hidden">
        ...
        <div className="flex items-center justify-between px-3 py-2 bg-[#171c23] border-b border-[#30353d]/40">
          <div className="flex items-center gap-2">
            ...
            <span className="font-code-sm text-[#dee2ec] font-medium ml-1">
        ...
        <div className="relative overflow-x-auto p-2.5 font-code-sm leading-[22px] select-text">
          <div className="min-w-[460px] flex">
            {/* Line Numbers Column */}
      ...
      <div className="flex flex-col bg-[#171c23] rounded-xl p-3 border border-[#30353d]/40 shadow-md space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-label-sm text-[#4edea3] bg-[#4edea3]/10 px-2 py-0.5 rounded-full flex items-center gap-1">
        ...
        <div className="grid grid-cols-3 gap-2 font-code-sm">
          <div className="bg-[#090f15] rounded-lg p-2 flex flex-col border border-[#30353d]/30">
        ...
        <div className="bg-[#090f15] rounded-xl p-3.5 font-code-sm overflow-x-auto shadow-inner border border-[#30353d]/40">
          ...
          <div className="flex flex-col gap-2 font-mono">
            ...
            {executionResult.stderr && executionResult.exitCode !== 0 ? (
              ...
              <div className="bg-[#121820] text-[#4edea3] p-3 rounded-lg border border-[#4edea3]/25 font-mono text-sm font-semibold whitespace-pre-wrap leading-relaxed shadow-sm">
                {executionResult.stdout || '[Program executed with empty output]'}
              </div>
            )}

            {/* Status Footer */}
            <div className="flex items-center justify-between pt-1 text-[11px] text-[#86948a] border-t border-[#30353d]/20">
