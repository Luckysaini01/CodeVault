...
public class Solution {
  ...
  return (
    <div className="flex flex-col w-full gap-4 max-w-lg mx-auto pb-10">
      {/* Header Intro Unit */}
      <section className="flex flex-col gap-1 mt-1">
        <div className="flex items-center justify-between">
          ...
          <span className="font-code-sm text-[#bbcabf] flex items-center gap-1">
            ...
            Instant Ephemeral Run
          </span>
        </div>
        <h1 className="font-headline-lg-mobile text-[#dee2ec] font-semibold tracking-tight">
          Public Code Runner
        </h1>
        <p className="font-body-sm text-[#bbcabf] leading-relaxed">
          Execute code safely in an isolated sandbox — no account needed. Zero setup, real-time telemetry.
        </p>
      </section>

      {/* Language Selector Pill Carousel */}
      <section className="flex items-center gap-1.5 overflow-x-auto pb-1 -mx-4 px-4 no-scrollbar" role="tablist">
        {(
          [
            { id: 'c' as LangKey, label: 'C (GCC 12)', icon: 'memory', iconColor: 'text-[#7bd0ff]' },
            { id: 'cpp' as LangKey, label: 'C++ 20', icon: 'code', iconColor: 'text-[#4cd7f6]' },
            { id: 'java' as LangKey, label: 'Java 17', icon: 'coffee', iconColor: 'text-[#4edea3]' },
            { id: 'python' as LangKey, label: 'Python 3.10', icon: 'terminal', iconColor: 'text-[#dee2ec]' },
            { id: 'javascript' as LangKey, label: 'JavaScript (ES2023)', icon: 'javascript', iconColor: 'text-[#7bd0ff]' }
          ]
        ).map((lang) => {
      ...
      <div className="flex flex-col bg-[#171c23] rounded-xl border border-[#30353d]/50 shadow-md overflow-hidden">
        ...
        {/* Code Editor Body */}
        <div className="flex relative bg-[#090f15] text-[#dee2ec] font-code-sm overflow-x-auto min-h-[280px] max-h-[380px] py-2">
          {/* Line Number Rail */}
          ...
          <div className="flex-1 flex flex-col pl-3">
            <textarea
              ...
              spellCheck={false}
              className="w-full h-full min-h-[260px] bg-transparent text-[#dee2ec] font-code-sm leading-6 outline-none resize-none selection:bg-[#4edea3] selection:text-[#003824] whitespace-pre"
      ...
      <section className="flex flex-col gap-1.5">
        <div className="flex items-stretch gap-2">
          <button
            onClick={handleRun}
            disabled={isRunning}
            className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#10b981] text-[#003824] font-headline-sm font-semibold tracking-tight shadow-lg shadow-[#10b981]/25 hover:brightness-110 active:scale-[0.98] transition-all cursor-pointer disabled:opacity-75"
          >
      ...
      <section className="flex flex-col bg-[#090f15] rounded-xl border border-[#30353d]/50 shadow-lg overflow-hidden">
        ...
        {activeTab === 'stdout' && (
          <div className="p-3 font-code-md leading-relaxed text-[#dee2ec] overflow-x-auto min-h-[160px] bg-[#090f15]">
        ...
        {activeTab === 'error' && (
          <div className="p-3 font-code-md leading-relaxed overflow-x-auto min-h-[160px] bg-[#090f15]">
            <div className="text-[#bbcabf]/70 mb-2 flex items-center gap-1.5 select-none font-code-sm">
              <span className="text-[#4cd7f6] font-semibold">$</span>
        ...
        {activeTab === 'stdin' && (
          <div className="p-3 font-code-md leading-relaxed bg-[#090f15] min-h-[160px] flex flex-col gap-2">
            <div className="flex items-center justify-between">
